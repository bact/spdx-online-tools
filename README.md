...
5. (Optional) If you want use license-xml-editor with licenses/exceptions
   from [SPDX license list](https://github.com/spdx/license-list-data/),
   download the license name database:
