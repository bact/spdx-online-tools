...
def getAuthCode():
    """important for the license submit tests, given that this
    authentication code is necessary to generate a GitHub access token.
    Authentication code generated by client from
