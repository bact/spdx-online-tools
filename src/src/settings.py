...
DEV_REPO_URL = f'https://api.github.com/repos/spdx/{LICENSE_TEST_REPO_NAME}'
PROD_REPO_URL = f'https://api.github.com/repos/spdx/{LICENSE_PROD_REPO_NAME}'
...
NAMESPACE_DEV_REPO_URL = f'https://api.github.com/repos/spdx/{NAMESPACE_TEST_REPO}'
NAMESPACE_PROD_REPO_URL = f'https://api.github.com/repos/spdx/{NAMESPACE_REPO_NAME}'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get(key='SQL_DATABASE', default=BASE_DIR / 'db.sqlite3'),
